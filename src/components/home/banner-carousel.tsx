        ...
        <CarouselContent>
          {banners.map((banner) => (
            <CarouselItem key={banner.id}>
              <div className={`w-full h-32 bg-gradient-to-r ${banner.gradient} p-4 flex items-center rounded-xl`}>
                <div className="flex-1">
                  <h2 className="text-white text-xl font-bold mb-2">{banner.title}</h2>
                  <p className="text-white text-sm opacity-90">{banner.description}</p>
                </div>
